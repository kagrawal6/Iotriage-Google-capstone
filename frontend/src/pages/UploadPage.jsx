...
export default function UploadPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <h1 className="text-2xl font-bold text-slate-900 mb-1">Upload Scan Results</h1>
      <p className="text-sm text-slate-500 mb-6">
        Upload the <code>scan_results.json</code> file generated by the IoTriage
        scanner. Select which devices to analyze, then submit. Analysis matches{" "}
        <TermTip term="CPE">CPEs</TermTip> from your scan to{" "}
        <TermTip term="CVE">CVEs</TermTip> listed in the{" "}
        <TermTip term="NVD">NVD</TermTip>.
      </p>
