...
export default function UploadPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <h1 className="text-xl font-bold text-slate-900 mb-1">Upload Scan Results</h1>
                ...
                className={`
                  ...
                  ${isSelected
                    ? mode.id === "beginner"
                      ...
                      ? "border-[#185abc] bg-[#185abc] !text-white"
                      : "border-[#b3261e] bg-[#b3261e] !text-white"
                    : "border-gray-200 hover:border-[#1a73e8]/50 bg-white text-black"
                  }
                `}
              >
                ...
                <p className={`text-xs font-medium mb-1 ${isSelected ? "!text-white" : "text-gray-500"}`}>
                  {mode.tagline}
                </p>
                <p className={`text-xs leading-snug ${isSelected ? "!text-white" : "text-gray-500"}`}>
                  {mode.description}
                </p>
              </button>
            );
      ...
      {parsedData && (
        <div className="mt-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              onClick={toggleAll}
              className="text-xs text-[#1a73e8] hover:text-[#1765cc] underline transition-colors"
            >
      ...
      <div className="mt-6">
        <button
          ...
          className="bg-[#1a73e8] text-white hover:bg-[#1765cc] disabled:opacity-40 disabled:cursor-not-allowed px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors"
        >
          {isLoading
            ? "Analyzing..."
            : noneSelected
