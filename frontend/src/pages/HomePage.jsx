...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-blue-50 via-white to-emerald-50 text-slate-900 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <div className="inline-flex items-center gap-2 bg-white rounded-full border border-slate-200 px-4 py-1.5 text-xs font-medium mb-6 text-slate-700">
          ...
          <div className="flex items-center justify-center gap-3">
            <Link
              to="/upload"
              className="inline-flex items-center gap-2 bg-[#1a73e8] !text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#1765cc] transition-colors shadow-sm"
            >
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center gap-1 text-[#188038] hover:text-[#0f9d58] px-4 py-2.5 text-sm font-medium transition-colors"
            >
              Learn more
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-8">
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-amber-50 text-[#f9ab00] flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-emerald-50 text-[#188038] flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <ol className="space-y-4 text-sm text-slate-600">
              <li className="flex gap-3">
                <span className="shrink-0 w-7 h-7 rounded-full bg-[#1a73e8] text-white flex items-center justify-center text-xs font-bold">1</span>
                <div>
                  <p className="font-semibold text-slate-900">Install Nmap</p>
                  <p>
                    Download from{" "}
                    <a href="https://nmap.org/download" target="_blank" rel="noreferrer" className="text-[#1a73e8] underline">
                      nmap.org
                    </a>{" "}
              ...
              <li className="flex gap-3">
                <span className="shrink-0 w-7 h-7 rounded-full bg-[#188038] text-white flex items-center justify-center text-xs font-bold">2</span>
                <div>
              ...
              <li className="flex gap-3">
                <span className="shrink-0 w-7 h-7 rounded-full bg-[#f9ab00] text-white flex items-center justify-center text-xs font-bold">3</span>
                <div>
                  <p className="font-semibold text-slate-900">Upload &amp; Analyze</p>
                  <p>
                    Go to{" "}
                    <Link to="/upload" className="text-[#188038] underline">Upload</Link>{" "}
                    and submit the JSON file. Select which devices to analyze.
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="shrink-0 w-7 h-7 rounded-full bg-[#d93025] text-white flex items-center justify-center text-xs font-bold">4</span>
                <div>
        ...
        <section className="mt-8">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            ...
            <a
              ...
              download
              className="inline-flex items-center gap-2 bg-[#188038] !text-white px-5 py-2.5 text-sm rounded-lg font-medium hover:bg-[#0f9d58] transition-colors"
            >
        ...
        <div className="text-center mt-10">
          <Link
            to="/upload"
            className="inline-flex items-center gap-2 bg-[#1a73e8] !text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#1765cc] transition-colors"
          >
            Get Started
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
