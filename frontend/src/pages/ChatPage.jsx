  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <Link
          to="/results"
          className="inline-flex items-center gap-1 text-sm text-[#1a73e8] hover:text-[#1765cc] transition-colors"
        >
      ...
      {/* Gemini notice */}
      <div className="bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 mb-3 text-xs text-[#1a73e8] flex items-center gap-2">
